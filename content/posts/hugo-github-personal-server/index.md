...
**DDNS（Dynamic Domain Name System）** 是“动态域名系统”的缩写。

为什么要用ddns技术：

> **虽然我们向运营商申请了公网地址，但这个IP并不是固定的。大约每隔24消失就会变换一次，ddns可以把动态IP和域名绑定，让你在公网 IP 经常变化的情况下，也能通过一个固定的域名访问你的设备。**
...
我以我家的内网地址为192.168.0.*  默认网关为 192.168.0.1
